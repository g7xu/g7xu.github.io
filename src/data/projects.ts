...
export const featuredProjects: Project[] = [
  {
    ...
    description: "An interactive visualization about blood glucose and diabetes",
...
export const researchProjects: ResearchProject[] = [
  {
    ...
    description: "User speak-aloud study exploring effective practices for novice data scientists",
