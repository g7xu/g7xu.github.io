...
## Computer Vision
- [[Computer Vision Overview]] — **sub-index** for the whole CV cluster: image formation & geometry, features & reconstruction, recognition & retrieval

## Robotics & Embodied AI
- [[Robotics & Embodied AI Overview]] — **sub-index** for the robotics cluster: VLA policies (the "brains") and humanoid platforms (the "bodies")
